...
const agencies: Record<string, AgencyData> = {
  noxis: {
    ...
    image: "/assets/agency-noxis_0cf9aca3.png",
  ...
  static: {
    ...
    image: "/assets/agency-static_ab26c49d.png",
  ...
  caliber: {
    ...
    image: "/assets/agency-caliber-bright_3bda9a1f.png",
  ...
  lazarus: {
    ...
    image: "/assets/agency-lazarus-bright_0b0d2d1a.png",
  ...
  blackrose: {
    ...
    color: "#6b0099",
    image: "/assets/agency-blackrose-bright_3395afb7.png",
  ...
  return (
    <div className="min-h-screen pt-20 pb-16">
      ...
      <div className="relative w-full h-[250px] md:h-[350px] overflow-hidden">
        <img src={agency.image} alt={agency.name} className="w-full h-full object-cover opacity-80" />
